...
def enum2str(enumValue, baseClass=None):
    """
    Returns an enum value as text
    ...
    """
    meta_enum = metaEnumFromType(enumValue.__class__, baseClass)
    ...
    return meta_enum.valueToKey(enumValue)
